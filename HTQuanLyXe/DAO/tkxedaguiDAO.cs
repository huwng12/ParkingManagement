...
namespace HTQuanLyXe.DAO
{
    class tkxedaguiDAO
    {
        ...
        {
            String Query = "select * from XE where loaiXe='Ô tô' and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        {
            String Query = "select * from XE where loaiXe='Xe máy'and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        {
            String Query = "select * from XE where loaiXe='Xe đạp'and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        {
            String Query = "select * from XE where bienSo like'%" + ma + "%'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            List<thongkeDTO> listadmin = new List<thongkeDTO>();
            foreach (DataRow item in data.Rows)
        ...
        {
            String Query = "select * from XE where loaiVe=N'Vé lượt'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        {
            String Query = "select * from XE where loaiVe=N'Vé tháng' and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        //số xe đạp gửi theo lượt
        public int soxedapguitheoluot()
        {
            String Query = "select * from XE where loaiXe=N'Xe đạp' and loaiVe=N'Vé lượt'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        {
            String Query = "select * from XE where loaiXe=N'Xe máy' and loaiVe=N'Vé tháng' and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        //tổng xe đạp gửi theo tháng
        public int soxedapguitheothang()
        {
            String Query = "select * from XE where loaiXe=N'Xe đạp' and loaiVe=N'Vé tháng' and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        {
            String Query = "select * from XE where loaiXe='Ô tô' and loaiVe='Vé tháng' and maSoVe!='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
