...
namespace HTQuanLyXe.DAO
{
    class tkvethangDAO
    {
        ...
        // số xe đạp đăng ký vé tháng
        public int tongxedap()
        {
            String Query = "select * from XE where loaiXe='Xe đạp' and loaiVe='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
        ...
        public int tongxedaptk()
        {
            String Query = "select * from THONGKE where loaiXe='Xe đạp' and loaiVe='Vé tháng'";
            DataTable data = new DataTable();
            data = dataprovider.Instance.ExcuteQuery(Query);
            return data.Rows.Count;
        }
