...
namespace HTQuanLyXe.GUI.QUANLYXE
{
    public partial class danhsachxe : Form
    {
        ...
        public static Boolean xedap = false;
        ...
        public danhsachxe()
        {
            ...
            dataGridViewxe.Columns[4].HeaderText = "người gửi";
        ...
        private void dataGridViewxe_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                else if (dataGridViewxe.Rows[index].Cells[2].Value.ToString() == "Xe đạp")
                    txtloaixe.SelectedIndex = 2;
                txttenxe.Text = dataGridViewxe.Rows[index].Cells[3].Value.ToString();
                txtnguoigui.Text = dataGridViewxe.Rows[index].Cells[4].Value.ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (txtloaixe.Text == "Xe đạp")
            {
                loaitest = true;
                loaixe = "Xe đạp";
            }
            lbbienso.Text = ""; lbmasove.Text = ""; lbloaixe.Text = "";
            if (loaitest==false||!quanlyxeDAO.Instance.tontaixe(txtbien.Text) || !quanlyveDAO.Instance.tontaive(txtmasove.Text) || txtbien.Text.Length > 20 || txtmasove.Text.Length > 10 || txttenxe.Text.Length > 100 || txtnguoigui.Text.Length > 20 || txtbien.Text == "" || txtmasove.Text == "")
            {
                if (loaitest == false)
                ...
                if (txtnguoigui.Text.Length > 20)
                    lbmauxe.Text = "tên người gửi không được quá 20 ký tự.";
                return;
            }
            ...
            try
            {
                if (quanlyxeDAO.Instance.sua(txtmasove.Text,txtloaixe.Text, txtbien.Text, txttenxe.Text, txtnguoigui.Text))
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (loaitest == false || txtbien.Text.Length > 20 || txtmasove.Text.Length > 10 || txttenxe.Text.Length > 100 || txtnguoigui.Text.Length > 20 || txtbien.Text == "" || txtmasove.Text == "" || quanlyxeDAO.Instance.tontaixe(txtbien.Text) || quanlyxeDAO.Instance.tontaive(txtmasove.Text) || !quanlyveDAO.Instance.tontaive(txtmasove.Text))
            {
                if (loaitest == false)
                    lbloaixe.Text = "Chọn loại xe là  Ô tô hoặc xe máy";
                if (txtbien.Text == "")
            ...
            //{
                DateTime vao;
                vao = DateTime.Now;
                quanlyxeDAO.Instance.vaoben(txtmasove.Text, txtloaixe.Text, txtbien.Text, txttenxe.Text, txtnguoigui.Text, vao);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (txtbien.Text.Length > 20 || txtmasove.Text.Length > 10 || txttenxe.Text.Length > 100 || txtnguoigui.Text.Length > 20 || txtbien.Text == "" || txtmasove.Text == "" || !quanlyxeDAO.Instance.tontaixe(txtbien.Text) || !quanlyxeDAO.Instance.tontaive(txtmasove.Text) || !quanlyveDAO.Instance.tontaive(txtmasove.Text))
            {
                if (txtbien.Text == "")
                    lbbienso.Text = "Biển số không được để trống!";
                if (txtmasove.Text == "")
        ...
        private void btdkvethang_Click(object sender, EventArgs e)
        {
            ...
            if (quanlyxeDAO.Instance.vethang(txtbien.Text)||txtbien.Text.Length > 20 || txtmasove.Text.Length > 10 || txttenxe.Text.Length > 100 || txtnguoigui.Text.Length > 20 || txtbien.Text == "" || txttenxe.Text == "" || loaitest == false || txtnguoigui.Text == "")
            {
                ...
                if (txtbien.Text == "")
                    lbbienso.Text = "Biển số không được để trống!";
                if (txtnguoigui.Text == "")
                    lbmauxe.Text = "Tên người g không được để trống";
                if (txttenxe.Text == "")
            ...
            //{
                ...
                {
                    quanlyxeDAO.Instance.dangkyvethang(mave, loaixe, bien, tenxe, nguoigui, DateTime.Now);
                ...
                DateTime vao;
                vao = DateTime.Now;
                quanlyxeDAO.Instance.vaoben(mave, loaixe, bien, tenxe, nguoigui, vao);
                MessageBox.Show("Thêm thành công xe có biển số " + txtbien.Text + " với vé có mã " + txtmasove.Text + ".");
                hienthi();
            //}
            //catch
        ...
        private void txtnguoigui_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtloaixe_KeyPress(object sender, KeyPressEventArgs e)
        {
            if(txtloaixe.Text == "Xe đạp")
            {
                txtbien.Text = "XXXX XXXX";
            }
        }

        private void txtloaixe_SelectedValueChanged(object sender, EventArgs e)
        {
            if (txtloaixe.Text == "Xe đạp")
            {
                txtbien.Text = "XXXX XXXX";
